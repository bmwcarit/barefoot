...
public class DijkstraBenchmark {
    ...
    @Test
    public void testFastestPriority() {
        try {
            Set<RoadPoint> sources = map.spatial().nearest(new Point(11.58424, 48.17635));
            Set<RoadPoint> targets = map.spatial().nearest(new Point(11.72661, 48.39594));
