...
public class FilterTest {
    ...
    private class MockFilter extends Filter<MockElement, StateTransition, Sample> {
        ...
        @Override
        protected Set<Tuple<MockElement, Double>> candidates(Sample sample) {
        ...
        protected Tuple<StateTransition, Double> transition(Tuple<Sample, MockElement> predecessor,
            ...
            return new Tuple<StateTransition, Double>(new StateTransition(), states.transition(predecessor
                    .two().numid(), candidate.two().numid()));
        }
