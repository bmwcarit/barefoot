...
public class RouteTest {
    ...
    public void testGeometry() {
...

        {
            Polyline geometry1 =
                    (Polyline) GeometryEngine.geometryFromWkt("LINESTRING(" + p1 + "," + p2 + ","
                            + p4 + ")", WktImportFlags.wktImportDefaults, Geometry.Type.Polyline);
            Polyline geometry2 =
            ...
            osm.add(new BaseRoad(1L, 1L, 4L, 1L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                    .length(geometry1), geometry1));
            osm.add(new BaseRoad(2L, 4L, 1L, 2L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                    .length(geometry2), geometry2));
...

            {
                ...
                List<Road> path = new LinkedList<Road>(Arrays.asList(map.get(2), map.get(4)));
                Route route = new Route(source, target, path);

                List<String> sequence = new LinkedList<String>(Arrays.asList(p2, p4));
                ...
                for (String wkt : sequence) {
                    Point point1 =
                            (Point) GeometryEngine.geometryFromWkt("POINT(" + wkt + ")",
            ...
            }
            {
                ...
                List<String> sequence = new LinkedList<String>(Arrays.asList(p1, p2, p4, p1));
        ...
        }
        {
            ...
            Polyline geometry2 =
                    (Polyline) GeometryEngine.geometryFromWkt("LINESTRING(" + p4 + "," + p1 + ","
                            + p3 + ")", WktImportFlags.wktImportDefaults, Geometry.Type.Polyline);
            Polyline geometry3 =
                    (Polyline) GeometryEngine.geometryFromWkt("LINESTRING(" + p3 + "," + p5 + ","
                            + p1 + ")", WktImportFlags.wktImportDefaults, Geometry.Type.Polyline);

            List<BaseRoad> osm = new LinkedList<BaseRoad>();
            osm.add(new BaseRoad(1L, 1L, 2L, 1L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                    .length(geometry1), geometry1));
            osm.add(new BaseRoad(2L, 2L, 3L, 2L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                    .length(geometry2), geometry2));
            osm.add(new BaseRoad(3L, 3L, 4L, 3L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                    .length(geometry3), geometry3));
...

            {
                ...
                List<Road> path =
                        new LinkedList<Road>(Arrays.asList(map.get(7), map.get(5), map.get(3)));
                Route route = new Route(source, target, path);

                List<String> sequence = new LinkedList<String>(Arrays.asList(p5, p3, p1, p4, p2));
            ...
            }
            {
                ...
                List<Road> path = new LinkedList<Road>(Arrays.asList(map.get(7)));
                Route route = new Route(source, target, path);

                List<String> sequence = new LinkedList<String>(Arrays.asList(p5));
    ...
    public void testAdd() {
        ...
        osm.add(new BaseRoad(1L, 1L, 2L, 1L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry1), geometry1));
        osm.add(new BaseRoad(2L, 3L, 1L, 2L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry2), geometry2));
        osm.add(new BaseRoad(3L, 4L, 1L, 3L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry3), geometry3));
        osm.add(new BaseRoad(4L, 1L, 5L, 4L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry4), geometry4));
        osm.add(new BaseRoad(5L, 2L, 4L, 5L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry5), geometry5));
        osm.add(new BaseRoad(6L, 5L, 3L, 6L, false, (short) 1, 1F, 60F, 60F, (float) spatial
                .length(geometry6), geometry6));
...

        {
            ...
            List<Road> path1 = new LinkedList<Road>(Arrays.asList(map.get(2)));
            ...
            List<Road> path2 = new LinkedList<Road>(Arrays.asList(map.get(2), map.get(10)));
            ...
            List<String> sequence = new LinkedList<String>(Arrays.asList(p2));
        ...
        }
        {
            ...
            List<Road> path1 = new LinkedList<Road>(Arrays.asList(map.get(2), map.get(10)));
            Route route1 = new Route(point11, point12, path1);
            ...
            List<Road> path2 = new LinkedList<Road>(Arrays.asList(map.get(10), map.get(11)));
            Route route2 = new Route(point21, point22, path2);
            ...
            sequence = new LinkedList<String>(Arrays.asList(p2, p4));
        ...
        }
        {
            ...
            RoadPoint point22 = new RoadPoint(map.get(11), 0.3);
            List<Road> path2 = new LinkedList<Road>(Arrays.asList(map.get(11)));
            Route route2 = new Route(point21, point22, path2);
        ...
        }
        {
            ...
            List<String> sequence = new LinkedList<String>(Arrays.asList(p1, p2, p4));
            ...
            sequence = new LinkedList<String>(Arrays.asList(p1, p2, p4));
    ...
    public void testGeometryBug() throws SourceException, JSONException, IOException {
        RoadMap map =
                RoadMap.Load(new PostGISReader("127.0.0.1", 5432, "bayern", "bfmap_ways",
                        "osmuser", "pass", Configuration.read("./bfmap/road-types.json")));
        map.construct();

        String json =
                "{\"roads\":[2675296, 3766758, 3209202, 2051292, 2815288, 2051286, 3209220, "
        ...
        System.out.println(GeometryEngine.geometryToWkt(route.geometry(),
