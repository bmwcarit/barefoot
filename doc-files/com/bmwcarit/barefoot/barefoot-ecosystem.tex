...
\begin{document}
	...
	\begin{tikzpicture}[font=\sffamily]
		...
		\node[align=center] at (11.5,4.75) {Barefoot \\ map matching \\ server \\ \scriptsize{(stand-alone server)}};
		\draw[-latex,thick] (8.2,2) to (9.8,4.5);
		
		% Online map matching
		\draw[thick,dashed,rounded corners] (10.1,0.1) rectangle (12.9,2.9);
		\node[align=center] at (11.5,1.75) {Scalable offline$^1$ \\ map matching \\ \scriptsize{(Spark, Hadoop)}};
		...
		\node[align=center] at (11.5,-1.25) {Scalable online$^2$ \\ map matching \\ \scriptsize{(Storm, Spark} \\ \scriptsize{Streaming)}};
